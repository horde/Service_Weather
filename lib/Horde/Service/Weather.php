...
class Horde_Service_Weather
{
    ...
    public const FORECAST_3DAY = 3;
    public const FORECAST_5DAY = 5;
    public const FORECAST_7DAY = 7;
    public const FORECAST_10DAY = 10;

    /** Standard forecast summary **/
    public const FORECAST_TYPE_STANDARD = 1;

    /** Detailed forecast, contains a day/night component for each day **/
    public const FORECAST_TYPE_DETAILED = 2;

    /** Hourly forecast **/
    public const FORECAST_TYPE_HOURLY = 3;

    public const FORECAST_FIELD_WIND = 'wind';
    public const FORECAST_FIELD_PRECIPITATION = 'pop';
    public const FORECAST_FIELD_HUMIDITY = 'humidity';
    public const FORECAST_FIELD_ACCUMULATION = 'accum';

    /** Unit constants **/
    public const UNITS_STANDARD = 1;
    public const UNITS_METRIC = 2;

    /** Conversion constants **/
    public const CONVERSION_MPH_TO_KNOTS = 0.868976242;
    public const CONVERSION_KPH_TO_KNOTS = 0.5399568;
    public const CONVERSION_MPH_TO_KPH = 1.609344;
    public const CONVERSION_KPH_TO_MPH = 0.621371192;
    public const CONVERSION_MB_TO_INCHES = 0.0295301;
    public const CONVERSION_KM_TO_SM  = 0.6213699;

    /** Location search types **/
    public const SEARCHTYPE_STANDARD = 1;
    public const SEARCHTYPE_IP = 2;
    public const SEARCHTYPE_ZIP = 3;
    public const SEARCHTYPE_CITYSTATE = 4;
